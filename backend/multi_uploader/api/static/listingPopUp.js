function renderListingPopUp() {
    ...
    popup.innerHTML = `
        <div class="listingPopupHeader">
            ...
            <button class="listingPopupClose">X</button>
        </div>
        ...
        <div class="listingPopupBody">
            ...
            <select name="condition" class="listingSelect">
                <option value="" selected disabled >Condition</option>
                <option value="Nové">Nové</option>
                <option value="Použité, jako nové">Použité, jako nové</option>
                <option value="Použité, dobrý stav">Použité, dobrý stav</option>
                <option value="Použité, zachovalý stav">Použité, zachovalý stav</option>
            </select>
            ...
            <div class="platformSelector">
                <label class="platformCard">
                    <input type="checkbox" name="platforms" value="bazos">
                    <span>Bazos</span>
                </label>

                <label class="platformCard">
                    <input type="checkbox" name="platforms" value="sbazar">
                    <span>Sbazar</span>
                </label>
                ...
                <label class="platformCard">
                    <input type="checkbox" name="platforms" value="aukro">
                    <span>Aukro</span>
                </label>
            </div>
